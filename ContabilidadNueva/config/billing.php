...
<script type="module">
    ...
    import BilingConfigTab from './react-dist/config-accounting/billing/BilingConfigTab.js';

    ReactDOMClient.createRoot(document.getElementById('BilingConfigTab')).render(
        React.createElement(BilingConfigTab)
    );
</script>
<?php
include "../../footer.php";
