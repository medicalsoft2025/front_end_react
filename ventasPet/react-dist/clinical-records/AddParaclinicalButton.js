...
export const AddParaclinicalButton = () => {
  ...
  const handleSubmit = async data => {
    ...
    try {
      ...
      //@ts-ignore
      let minioId = await guardarResultadoRecetaExamen("addParaclinicalFormFile", res.id);
      await updateExamRecipeResult(res.id, {
        result_minio_id: minioId?.toString()
      });
  ...
  }), " Agregar paracl\xEDnico"), /*#__PURE__*/React.createElement(CustomFormModal, {
