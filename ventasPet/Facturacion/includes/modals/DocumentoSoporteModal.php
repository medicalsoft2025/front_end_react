...
<div class="modal fade" id="modalNuevoDocumentoSoporte" tabindex="-1" style="display: none;" aria-hidden="true">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Documento Soporte</h5><button class="btn btn-close p-1" type="button" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <div class="row g-3 mb-3">
                                                ...
                                                <div class="col-sm-4">
                                                    <div class="mb-2">
                                                        <label class="form-label text-body" for="bootstrap-wizard-validation-wizard-authorisation-number">Proveedor *</label>
                                                        <input class="form-control" type="number" name="authorisation-number" placeholder="Proveedor" required="required" id="bootstrap-wizard-validation-wizard-authorisation-number" data-wizard-confirm-password="true">
                                                        <div class="invalid-feedback">El campo es obligatorio</div>
                                                    </div>
                                                </div>
                                                <div class="col-sm-4">
                                                    <div class="mb-2">
                                                        <label class="form-label text-body" for="bootstrap-wizard-validation-entity">Tipo Identificación T. *</label>
                                                        <select class="form-select" name="entity" id="bootstrap-wizard-validation-entity">
                                                            <option value="">Seleccionar</option>
                                            ...
                                            <div class="row g-3 mb-3">
                                                <div class="col-sm-4">
                                                    <div class="mb-2 mb-sm-0">
                                                        <label class="form-label text-body" for="bootstrap-wizard-validation-entity">Identificacion T. *</label>
                                                        <select class="form-select" name="entity" id="bootstrap-wizard-validation-entity">
                                                            <option value="">Seleccionar</option>
                                                            <option value="entidad1">Entidad 1</option>
                                                            <option value="entidad2">Entidad 2</option>
                                                ...
                                                <div class="col-sm-4">
                                                    <div class="mb-2">
                                                        <label class="form-label text-body" for="bootstrap-wizard-validation-wizard-authorisation-number">Razon Social *</label>
                                                        <input class="form-control" type="number" name="authorisation-number" placeholder="Razon Social" required="required" id="bootstrap-wizard-validation-wizard-authorisation-number" data-wizard-confirm-password="true">
                                                        <div class="invalid-feedback">El campo es obligatorio</div>
                                                    </div>
                                                </div>
                                                <div class="col-sm-4">
                                                    <div class="mb-2">
                                                        <label class="form-label text-body" for="bootstrap-wizard-validation-entity">Tipo de sociedad *</label>
                                                        <select class="form-select" name="entity" id="bootstrap-wizard-validation-entity">
                                                            <option value="">Seleccionar</option>
                                                            <option value="centro1">Centro 1</option>
                                                            <option value="centro2">Centro 2</option>
                                            ...
                                            <div class="row g-3 mb-3">
                                                <div class="col-sm-4">
                                                    <div class="mb-2 mb-sm-0">
                                                        <label class="form-label text-body" for="bootstrap-wizard-validation-entity">Direccion *</label>
                                                        <select class="form-select" name="entity" id="bootstrap-wizard-validation-entity">
                                                            <option value="">Seleccionar</option>
                                                            <option value="entidad1">Entidad 1</option>
                                                            <option value="entidad2">Entidad 2</option>
                                                ...
                                                <div class="col-sm-4">
                                                    <div class="mb-2">
                                                        <label class="form-label text-body" for="bootstrap-wizard-validation-wizard-authorisation-number">Numero de Telefono *</label>
                                                        <input class="form-control" type="number" name="authorisation-number" placeholder="Numero de Telefono" required="required" id="bootstrap-wizard-validation-wizard-authorisation-number" data-wizard-confirm-password="true">
                                                        <div class="invalid-feedback">El campo es obligatorio</div>
                                                    </div>
                                                </div>
                                                <div class="col-sm-4">
                                                    <div class="mb-2">
                                                        <label class="form-label text-body" for="bootstrap-wizard-validation-entity">Email *</label>
                                                        <select class="form-select" name="entity" id="bootstrap-wizard-validation-entity">
                                                            <option value="">Seleccionar</option>
                                                            <option value="centro1">Centro 1</option>
                                                            <option value="centro2">Centro 2</option>
