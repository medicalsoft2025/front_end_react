                                    ...
                                    <div class="col-8 col-sm-6">
                                        ...
                                        <div class="row">
                                            <div class="col">
                                                <div class="input-group">
                                                    <div class="form-floating">
                                                        <input type="number" class="form-control" min="0" id="reference"
                                                            required name="reference">
                                                        <label for="reference" class="form-label">Referencia</label>
                                                        <div class="invalid-feedback">Por favor ingrese la referencia del producto</div>
                                                    </div>
                                                </div>
                                            </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            ...
            form.addEventListener('submit', async (e) => {
                ...
                try {
                    ...
                    if (!response.ok) {
                        ...
                        const modal = bootstrap.Modal.getInstance(document.getElementById('modalNuevoMedicamento'));
                        modal.hide();
            ...
            imageInput.addEventListener('change', function() {
                const preview = document.getElementById('medicamentoPreview');
