          ...
          <div class="wizard-content">
            ...
            <div class="wizard-step active" data-step="1">
              <div class="mt-1">
                ...
                <select class="form-select" id="assigned_user_specialty_id" name="assigned_user_specialty_id" required>
              ...
              <div class="mb-2">
                ...
                <select class="form-select" id="assigned_user_availability_id" required name="assigned_user_availability_id" disabled>
            ...
            <div class="wizard-step" data-step="2">
              <div class="mb-2 d-flex flex-column gap-3">
                ...
                <div class="d-flex align-items-center gap-3 flex-wrap">
                  <div class="form-check">
                    <input class="form-check-input" type="radio" name="appointment_type_id" id="tipoCitaPresencial" value="1" required>
                    <label class="form-check-label" for="tipoCitaPresencial">Presencial</label>
                  </div>
                  <div class="form-check">
                    <input class="form-check-input" type="radio" name="appointment_type_id" id="tipoCitaDomiciliaria" value="2" required>
                    <label class="form-check-label" for="tipoCitaDomiciliaria">Domiciliaria</label>
                  </div>
                  <div class="form-check">
                    <input class="form-check-input" type="radio" name="appointment_type_id" id="tipoCitaVirtual" value="3" required>
              ...
              <div class="row g-3">
                <div class="col-sm-6">
                  <div class="mb-2 mb-sm-0">
                    ...
                    <select class="form-select" name="product_id" id="product_id" required="required">
                ...
                <div class="col-sm-6">
                  <div class="mb-2 mb-sm-0">
                    <label class="form-label" for="consultation_purpose">Finalidad de la consulta *</label>
                    <select class="form-select" name="consultation_purpose" id="consultation_purpose" required>
                      <option value="">Seleccionar</option>
                      <?php foreach ($purposeConsultation as $key => $value) { ?>
                        <option value="<?= $key ?>"><?= $value ?></option>
                      <?php } ?>
                    </select>
                    <div class="invalid-feedback">Por favor seleccione la finalidad de la consulta.</div>
                  </div>
                </div>
              </div>
              ...
              <div class="mb-2">
                <div class="form-check">
                  <input class="form-check-input" type="checkbox" id="citaRecurrente" name="citaRecurrente">
                  <label class="form-check-label text-uppercase" for="citaRecurrente">Cita recurrente</label>
                </div>
              </div>
              ...
              <div id="recurrenteOptions" style="display: none;">
                ...
                <div class="mb-2">
                  ...
                  <input class="form-control" type="number" id="numRepeticiones" name="numRepeticiones" min="1">
                </div>
              </div>
    ...
    if (Array.isArray(products)) { // Verifica si products es un array
      products.forEach(product => {
        ...
        if (attributes && attributes.name) {
          ...
          option.setAttribute('data-price', attributes.sale_price); // Accede al precio del producto desde attributes
