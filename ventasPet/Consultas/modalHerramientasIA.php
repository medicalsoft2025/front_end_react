<div class="modal fade" id="modalHerramientasIA" tabindex="-1" aria-labelledby="modalHerramientasIA" aria-hidden="true">
    <div class="modal-dialog modal-xl modal-dialog-scrollable">
        <div class="modal-content">
            ...
            <input type="hidden" id="dataIA" value="">
...
<script type="module">
    ...
    const dataInput = document.getElementById("dataIA");
    ...
    //     document.getElementById("medication").value = "Medicamento 1";
    //     document.getElementById("concentration").value = "500 mg";
    //     document.getElementById("frequency").value = "Diaria";
    //     document.getElementById("duration").value = "5";
    //     document.getElementById("medication_type").value = "tabletas";
    //     document.getElementById("take_every_hours").value = "12";
    ...
    generarTodoBtn.addEventListener("click", () => {
        ...
        fetch("https://hooks.medicalsoft.ai/webhook/herramientasia", {
            ...
            .then(dataRespuesta => {
                ...
                dataInput.value = JSON.stringify(responseIA);
                dataInput.dataset.jsonData = dataInput.value;
            ...
            <div>
                ...
                <div>
                    ...
                    <div style="border: 1px solid #e0e0e0; padding: 12px; border-radius: 8px;">
                        ...
                        <p style="margin: 0 0 3px 0;"><strong>Duración:</strong> ${med.posologia
}</p>
    ...
    //     loaderResumenHistoria.style.display = "block";
    //     generarTodoBtn.disabled = true;

    //     const contenidoPrevioResumenHistoria = document.getElementById('contenidoResumenHistoria');
    //     if (contenidoPrevioResumenHistoria) {
    //         resumenHistoria.removeChild(contenidoPrevioResumenHistoria);
    //     }

    //     const contenidoPrevioSugerenciaDiagnostico = document.getElementById('contenidoSugerenciaDiagnostico');
    //     if (contenidoPrevioSugerenciaDiagnostico) {
    //         sugerenciaDiagnostico.removeChild(contenidoPrevioSugerenciaDiagnostico);
    //     }

    //     const contenidoPrevioSugerenciaTratamiento = document.getElementById('contenidoSugerenciaTratamiento');
    //     if (contenidoPrevioSugerenciaTratamiento) {
    //         sugerenciaTratamiento.removeChild(contenidoPrevioSugerenciaTratamiento);
    //     }

    //     const contenidoPrevioGenerarTodo = document.getElementById('contenidoGenerarTodo');
    //     if (contenidoPrevioGenerarTodo) {
    //         cardTodo.removeChild(contenidoPrevioGenerarTodo);
    //     }

    //     data.request = "Generar todo";
    //     data.data = captureFormValues(formData.form1);

    //     console.log("data generar todo", data);

    //     const res = fetch("https://hooks.medicalsoft.ai/webhook/herramientasia", {
    //             method: "POST",
    //             headers: {
    //                 "Content-Type": "application/json"
    //             },
    ...
    //         })
    //         .then(dataRespuesta => {
    //             loaderResumenHistoria.style.display = "none";
    //             generarTodoBtn.disabled = false;
    //             console.log("Respuesta del servidor:", dataRespuesta);
    ...
    //             const responseContainerResumen = document.createElement('div');
    //             responseContainerResumen.id = 'contenidoResumenHistoria';

    //             const responseContainerDiagnostico = document.createElement('div');
    //             responseContainerDiagnostico.id = 'contenidoSugerenciaDiagnostico';

    //             const responseContainerTratamiento = document.createElement('div');
    //             responseContainerTratamiento.id = 'contenidoSugerenciaTratamiento';
    ...
    //             const tratamiento = typeof dataRespuesta.tratamientoSugerido === 'string' ?
    //                 dataRespuesta.tratamientoSugerido.replace(/^"|"$/g, '') :
    //                 JSON.stringify(dataRespuesta.tratamientoSugerido, null, 2);

    //             responseContainerResumen.innerHTML =
    //                 `<div style="margin: 0 0 10px 25px;">
    //                 <h4 style="margin: 0 0 5px 0;">Resumen de historia</h4>
    //                 <p>${resumen}</p>
    //                 </div>
    //                 <div class="text-end">
    //                     <button class="btn btn-primary btn-sm" id="btnGenerarResumen"><i
    //                             class="fas fa-sync"></i></button>
    //                 </div>`;
    //             // <div style="margin: 0 0 10px 25px;">
    //             //     <h4 style="margin: 5px 0;">Diagnóstico sugerido</h4>
    //             //     <p>${diagnostico}</p>
    //             // </div>
    //             // <div style="margin: 0 0 10px 25px;">
    //             //     <h4 style="margin: 5px 0;">Tratamiento sugerido</h4>
    //             //     <p>${tratamiento}</p>
    //             // </div>`;
    //             resumenHistoria.appendChild(responseContainerResumen);
    //             generateSummary();

    //             responseContainerDiagnostico.innerHTML =
    //                 `<div style="margin: 0 0 10px 25px;">
    //                 <h4 style="margin: 5px 0;">Diagnóstico sugerido</h4>
    //                 <p>${diagnostico}</p>
    //                 <h4 style="margin: 5px 0;">Detalles</h4>
    //                 <p>${detalles}</p>
    //                 </div>
    //                 <div class="text-end">
    //                     <button class="btn btn-primary btn-sm" id="btnGenerarDiagnostico"><i
    //                             class="fas fa-sync"></i></button>
    //                 </div>`;
    //             sugerenciaDiagnostico.appendChild(responseContainerDiagnostico);
    ...
    //             htmlContentTratamiento += `
    //             <div class="text-end">
    //                 <button class="btn btn-primary btn-sm" id="btnGenerarTratamiento"><i
    //                         class="fas fa-sync"></i></button>
    //             </div>`;

    //             // responseContainerTratamiento.innerHTML =
    //             //     `<div style="margin: 0 0 10px 25px;">
    //             //     <h4 style="margin: 5px 0;">Tratamiento sugerido</h4>
    //             //     <p>${tratamiento}</p>
    //             //     <div class="text-end">
    ...
    //             // </div>
    //             // </div>`;
    //             responseContainerTratamiento.innerHTML = htmlContentTratamiento;
    //             sugerenciaTratamiento.appendChild(responseContainerTratamiento);
    //         })
    //         .catch(error => {
    //             console.error("Error:", error);
    //             const errorContainer = document.createElement('div');
    ...
    //             resumenHistoria.appendChild(errorContainer);
    //         })
    // })
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function updateNavigation() {
            ...
            if (currentStep === totalSteps) {
                ...
                aprobarBtn.style.display = 'block';
            } else {
    ...
    //                 // console.log("Respuesta del servidor:", dataRespuesta);
    //                 // loaderResumenHistoria.style.display = "none";
    //                 // resumenHistoriaBtn.disabled = false;
    //                 btnGenerarResumen.disabled = false;

    //                 const responseContainerResumen = document.createElement('div');
    //                 responseContainerResumen.id = 'contenidoResumenHistoria';

    //                 responseIA.resumen = dataRespuesta.resumenHistoria;
    //                 // dataInput.value = JSON.stringify(responseIA);
    //                 // dataInput.dataset.jsonData = dataInput.value;
    ...
    //                 responseContainerResumen.innerHTML =
    //                     `<div style="margin: 0 0 10px 25px;">${contenido}</div>`;
    ...
    generarResumenBtn.addEventListener("click", () => {
        // loaderResumenHistoria.style.display = "block";
        // resumenHistoriaBtn.disabled = true;

        // const contenidoPrevioResumen = document.getElementById('contenidoResumenHistoria');
        // if (contenidoPrevioResumen) {
        //     resumenHistoria.removeChild(contenidoPrevioResumen);
        // }
        ...
        fetch("https://hooks.medicalsoft.ai/webhook/resumen", {
            ...
            .then(dataRespuesta => {
                ...
                responseIA.resumen = dataRespuesta.resumenHistoria;
                // let newResumen = JSON.parse(dataInput.dataset.jsonData);
                // newResumen.resumen = dataRespuesta.resumenHistoria;
                // dataInput.value = JSON.stringify(newResumen);
                // dataInput.dataset.jsonData = dataInput.value;
                // dataInput.value = JSON.stringify(responseIA);
                // dataInput.dataset.jsonData = dataInput.value;
                ...
                contenidoResumenHistoria.innerHTML =
                    `<div>${contenido}</div>`;
                // responseContainerResumen.innerHTML = `<div style="margin: 0 0 10px 25px;">${contenido}</div>`;
    ...
    generarDiagnosticoBtn.addEventListener("click", () => {
        ...
        fetch("https://hooks.medicalsoft.ai/webhook/diagnostico", {
            ...
            .then(dataRespuesta => {
                console.log("Respuesta del servidor:", dataRespuesta);
                // loaderSugerenciaDiagnostico.style.display = "none";
                // sugerenciaDiagnosticoBtn.disabled = false;
                generarDiagnosticoBtn.disabled = false;

                contenidoSugerenciaDiagnostico.innerHTML = "";

                responseIA.diagnostico = dataRespuesta.diagnosticoSugerido;
                // let newDiagnostico = JSON.parse(dataInput.dataset.jsonData);
                // newDiagnostico.diagnostico = dataRespuesta.diagnosticoSugerido;
                // dataInput.value = JSON.stringify(newDiagnostico);
                // dataInput.dataset.jsonData = dataInput.value;
    ...
    // sugerenciaDiagnosticoBtn.addEventListener("click", () => {
    //     loaderSugerenciaDiagnostico.style.display = "block";
    //     sugerenciaDiagnosticoBtn.disabled = true;
    ...
    //             responseContainer.id = 'contenidoSugerenciaDiagnostico';

    //             responseIA.sugerenciaDiagnostico.diagnostico = dataRespuesta.diagnosticoSugerido;
    //             responseIA.sugerenciaDiagnostico.detalles = dataRespuesta.detalles;
    //             // dataInput.value = JSON.stringify(responseIA);
    //             // dataInput.dataset.jsonData = dataInput.value;
    ...
    //                 `<div style="margin: 0 0 10px 25px;"><strong>Diagnóstico: </strong><p>${diagnostico}</p></div>
    //         <div style="margin: 0 0 10px 25px;"><strong>Detalles: </strong><p>${detalles}</p></div>`;

    //             sugerenciaDiagnostico.appendChild(responseContainer);
    ...
    //             errorContainer.innerHTML =
    //                 `<div style="margin: 0 0 10px 25px; color: red;">Error: ${error.message}</div>`;
    //             sugerenciaDiagnostico.appendChild(errorContainer);
    ...
    generarTratamientoBtn.addEventListener("click", () => {
        ...
        fetch("https://hooks.medicalsoft.ai/webhook/tratamiento", {
            ...
            .then(dataRespuesta => {
                ...
                responseIA.sugerenciaTratamiento = dataRespuesta.tratamientoSugerido;
                // let newTratamiento = JSON.parse(dataInput.dataset.jsonData);
                // newTratamiento.sugerenciaTratamiento = dataRespuesta.tratamientoSugerido;
                // dataInput.value = JSON.stringify(newTratamiento);
                // dataInput.dataset.jsonData = dataInput.value;
...
.incapacidadSugerida.motivo}</p>
    ...
    // sugerenciaTratamientoBtn.addEventListener("click", () => {
    //     loaderSugerenciaTratamiento.style.display = "block";
    //     sugerenciaTratamientoBtn.disabled = true;

    //     const contenidoPrevioTratamiento = document.getElementById('contenidoSugerenciaTratamiento');
    //     if (contenidoPrevioTratamiento) {
    //         sugerenciaTratamiento.removeChild(contenidoPrevioTratamiento);
    //     }

    //     data.request = "Sugerencia tratamiento";
    //     data.data = captureFormValues(formData.form1);

    //     const res = fetch("https://hooks.medicalsoft.ai/webhook/tratamiento", {
    //             method: "POST",
    //             headers: {
    //                 "Content-Type": "application/json"
    //             },
    ...
    //             loaderSugerenciaTratamiento.style.display = "none";
    //             sugerenciaTratamientoBtn.disabled = false;

    //             const responseContainer = document.createElement('div');
    //             responseContainer.id = 'contenidoSugerenciaTratamiento';

    //             responseIA.sugerenciaTratamiento = {
    //                 tratamiento: dataRespuesta.tratamientoSugerido,
    //                 examenes: dataRespuesta.posiblesExamenes,
    //                 medicacion: dataRespuesta.medicacionSugerida,
    //                 incapacidad: dataRespuesta.incapacidadSugerida
    //             };
    //             // dataInput.value = JSON.stringify(responseIA);
    //             // dataInput.dataset.jsonData = dataInput.value;
    ...
    //                 <div style="margin: 0 0 20px 25px;">
    //                     <h5>Tratamiento sugerido</h5>
    //                     <p>${dataRespuesta.tratamientoSugerido.replace(/^"|"$/g, '')}</p>
    //                 </div>`;

    //             if (dataRespuesta.posiblesExamenes && dataRespuesta.posiblesExamenes.length > 0) {
    //                 htmlContent += `
    //                 <div style="margin: 0 0 20px 25px;">
    //                     <h5>Exámenes recomendados</h5>
    //                     <ul style="margin: 0; padding-left: 20px;">`;

    //                 dataRespuesta.posiblesExamenes.forEach(examen => {
    //                     htmlContent += `<li style="margin-bottom: 5px;">${examen}</li>`;
    //                 });
    ...
    //             if (dataRespuesta.medicacionSugerida && dataRespuesta.medicacionSugerida.length > 0) {
    //                 htmlContent += `
    //                 <div style="margin: 0 0 20px 25px;">
    //                     <h5>Medicación recomendada</h5>
    //                     <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 15px; width: 98%;">`;

    //                 dataRespuesta.medicacionSugerida.forEach(med => {
    //                     htmlContent += `
    //                     <div style="border: 1px solid #e0e0e0; padding: 12px; border-radius: 8px;">
    //                         <p style="margin: 0 0 5px 0; font-weight: bold;">${med.nombre} ${med.concentracion}</p>
    //                         <p style="margin: 0 0 3px 0;"><strong>Tipo:</strong> ${med.tipo}</p>
    ...
    //             if (dataRespuesta.incapacidadSugerida && dataRespuesta.incapacidadSugerida.aplica) {
    //                 htmlContent += `
    //                 <div style="margin: 0 0 20px 25px;">
    //                     <h5>Incapacidad laboral</h5>
    //                         <p style="margin: 0 0 5px 0;"><strong>Días recomendados:</strong> ${dataRespuesta.incapacidadSugerida.dias}</p>
    //                         <p"><strong>Motivo:</strong> ${dataRespuesta.incapacidadSugerida.motivo}</p>
    //                 </div>`;
    //             }

    //             responseContainer.innerHTML = htmlContent;
    //             sugerenciaTratamiento.appendChild(responseContainer);
    ...
    function agregarIncapacidad() {
        if (responseIA.tratamientoSugerido.incapacidadSugerida && responseIA.tratamientoSugerido.incapacidadSugerida
            .aplica) {
            document.getElementById("btnAgregarIncapacidad").click();
            document.getElementById("dias").value = responseIA.tratamientoSugerido.incapacidadSugerida.dias;
            document.getElementById("reason").value = responseIA.tratamientoSugerido.incapacidadSugerida.motivo;
        }
    }
    ...
    aprobarBtn.addEventListener('click', () => {
        ...
        // Verificamos primero que exista medicacionSugerida y que sea un array
        // if (responseIA.tratamientoSugerido && responseIA.tratamientoSugerido.medicacionSugerida && Array.isArray(
        //         responseIA.tratamientoSugerido.medicacionSugerida)) {
        //     document.getElementById("btnAgregarReceta").click();

        //     // Recorremos cada medicamento en el array
        //     for (const medicamento of responseIA.tratamientoSugerido.medicacionSugerida) {
        //         // Hacemos click en el botón para agregar nueva receta

        //         // Rellenamos los campos con los valores del medicamento actual
        //         document.getElementById("medication").value = medicamento.nombre || "";
        //         document.getElementById("concentration").value = medicamento.concentracion || "";
        //         document.getElementById("frequency").value = medicamento.frecuencia || "";
        //         document.getElementById("duration").value = medicamento.duracion || "";
        ...
        //         // Hacemos click en el botón para agregar el medicamento
        //         document.getElementById("addMedicineBtn").click();
        ...
        dataInput.value = JSON.stringify(responseIA);
        dataInput.dataset.jsonData = dataInput.value;
        console.log("Aprobar: ", responseIA);
        // console.log("Data Input", dataInput)
        // console.log("Data Input", dataInput.value)
        // console.log("Data Input Json", dataInput.dataset.jsonData)
    })
