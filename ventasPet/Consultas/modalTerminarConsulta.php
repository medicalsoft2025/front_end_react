...
<script type="module">
    ...
    const responseIA = JSON.parse(dataInput.value);

    // document.getElementById("btnCloseFinish").addEventListener("click", function() {
    //     console.log("Input: ", dataInput);
    //     console.log("Value: ", dataInput.value);
    //     console.log("JSON: ", responseIA);
    //     console.log("resumen", responseIA.resumen);
    //     console.log("diagnostico", responseIA.sugerenciaDiagnostico);
    //     console.log("tratamiento", responseIA.sugerenciaTratamiento);
    // })
    ...
    document.getElementById("finalizarConsulta").addEventListener("click", function() {
        ...
        // console.log("Incapacidad :", dataIncapacidad);
        // console.log("Recetas :", dataRecetas);
        // console.log("Remisiones :", dataRemisiones);
        // console.log("Examen :", dataExamenes);
        const appointmentId = new URLSearchParams(window.location.search).get('appointment_id');
    ...
    function captureFormValues(formData) {
        ...
        const resumenIA = null;

        if (responseIA.aprobar == true) {
            resumenIA = responseIA.resumenHistoria;
        }
    ...
    //     console.log("Data IA: ", responseIA);
    //     document.getElementById("btnAgregarReceta").click();
