        ...
        <div class="row">
            <div class="col-12">
                <div class="row align-items-center justify-content-between">
                    ...
                    <div class="text-end">
                        <div id="addParaclinicalBtnReact"></div>
                        ...
                        <button class="btn btn-primary" disabled id="herramientasIABtn" type="button"
                            data-bs-toggle="modal" data-bs-target="#modalHerramientasIA">Herramientas IA</button>
...
<script type="module">
    ...
    ReactDOMClient.createRoot(document.getElementById('addParaclinicalBtnReact')).render(React.createElement(AddParaclinicalButton));
