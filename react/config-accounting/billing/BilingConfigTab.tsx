...
const BillingConfigTab: React.FC<BillingConfigTabProps> = ({
    ...
    useEffect(() => {
        const cargarCuentasContables = async () => {
            ...
            try {
                const response =
                    await accountingAccountsService.getAllAccounts();
    ...
    const guardarConfiguracion = async (
        ...
        try {
            ...
            if (data?.id) {
                await billingService.updateBillingConfiguration(
                    payload,
                    data.id
                );
            } else {
                  ...
                  <small className="p-error">Favor seleccione una cuenta contable.</small>
                        ...
                        <div className="field mb-4">
                            ...
                            <Dropdown
                                ...
                                value={accountingAccount}
                                onChange={(e) =>
                                    setValue("accounting_account", e.value)
                                }
                                filter
                                filterBy="account_name,account_code,label"
                                showClear
                    ...
                    <div className="col-md-6">
                        <div className="field mb-4">
                            ...
                            <InputNumber
                                ...
                                onValueChange={(e) =>
                                    setValue("invoice_from", e.value)
                                }
                                mode="decimal"
                                useGrouping={false}
                                min={1}
                                className={`w-full ${
                                    errors?.invoice_from ? "p-invalid" : ""
                                }`}
                                placeholder="Ej: 1001"
                                showButtons
                        ...
                        <div className="field mb-4">
                            ...
                            <InputNumber
                                ...
                                onValueChange={(e) =>
                                    setValue("invoice_to", e.value)
                                }
                                mode="decimal"
                                useGrouping={false}
                                min={1}
                                className={`w-full ${
                                    errors?.invoice_to ? "p-invalid" : ""
                                }`}
                                placeholder="Ej: 2000"
                                showButtons
                                buttonLayout="horizontal"
                        ...
                        <div className="field mb-4">
                            ...
                            <Calendar
                                ...
                                onChange={(e) =>
                                    setValue("resolution_date", e.value)
                                }
                                dateFormat="dd/mm/yy"
                                showIcon
                        ...
                        <div className="field mb-4">
                            ...
                            <Calendar
                                ...
                                onChange={(e) =>
                                    setValue("expiration_date", e.value)
                                }
                                dateFormat="dd/mm/yy"
                                showIcon
                                placeholder="Seleccione la fecha"
