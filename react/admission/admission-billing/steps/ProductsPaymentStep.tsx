...
const ProductsPaymentStep: React.FC<ProductsPaymentStep> = ({
    ...
    const handleAddProduct = () => {
        ...
        const newProduct = {
            ...
            total:
                (price || 0) *
                (1 + (procedure.tax_charge?.percentage || 0) / 100),
        };
    ...
    const paymentAmountBodyTemplate = (rowData: any) => {
        return (
            <span className="font-bold">{formatCurrency(rowData.total)}</span>
        );
    };

    const paymentChangeBodyTemplate = (rowData: any) => {
        return (
            <span className="font-bold">{formatCurrency(rowData.change)}</span>
        );
    };
        ...
        <div className="grid">
            <div className="col-12 md:col-8">
                <Card
                    title={
                        <>
                            <i className="fas fa-shopping-cart mr-2"></i> Lista
                            de Productos
                        </>
                    }
                            ...
                            <Column
                                ...
                                body={(rowData) => (
                                    <Button
                                        ...
                                        onClick={() =>
                                            handleRemoveProduct(rowData.uuid)
                                        }
                                        tooltip="Eliminar"
                                        tooltipOptions={{ position: "top" }}
                                    />
            ...
            <div className="col-12 md:col-4">
                <Card
                    title={
                        <>
                            <i className="fas fa-credit-card mr-2"></i> Métodos
                            de Pago
                        </>
                    }
