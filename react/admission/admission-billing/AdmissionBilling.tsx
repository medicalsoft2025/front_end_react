                ...
                try {
                    ...
                    const replacements = {
                        NOMBRE_PACIENTE: `${
                            ...
                            admissionData.admission_data.patient
                                .second_last_name ?? ""
                        }`,
                        NUMERO_FACTURA:
                        ...
                        MONTO_FACTURADO:
                            "$" +
                            admissionData.data_invoice.invoice.total_amount.toFixed(
                                2
                            ),
                        "ENLACE DOCUMENTO": "",
                    };
            ...
            if (isMounted.current) {
                setFormData({
                    ...
                    patient: {
                        ...
                        affiliateType:
                            patient.social_security?.affiliate_type || "",
                        ...
                        <div className="col-12">
                            <Card className="shadow-sm admission-billing-card">
                                <div className="configuration-content p-4 card border-0">
                                    {/* Stepper Horizontal - Solo visual */}
                                    <div
